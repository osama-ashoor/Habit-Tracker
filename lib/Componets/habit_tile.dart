...
class _HabitTileState extends State<HabitTile> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onLongPress: () {
        // Handle long press to delete the habit
        showDialog(
          context: context,
          builder: (context) {
            return AlertDialog(
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () {
                    // Delete the habit from the box and state
                    setState(() {
                      Box habitBox = Hive.box('habitDataBox');
                      Box habitDataBox = Hive.box('habitBox');

                      // Remove the habit dates from the box
                      habitDataBox.delete(widget.habitName);

                      // Remove the habit itself
                      habitBox.delete(widget.habitId);
